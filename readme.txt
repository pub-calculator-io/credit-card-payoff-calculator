...
== Usage ==
* Add the shortcode `[ci_credit_card_payoff_calculator]` to your page or post and configure default mortgage parameters.
* If you are using widgets, just add the Credit Card Payoff Calculator to the sidebar through the `Appearance -> Widgets -> Credit Card Payoff Calculator` menu in WordPress.
